  ...
  return (
    <>
      ...
      {showGuessLocation ? null : (
        <button
          className={cls(
            'absolute left-1/2 -translate-x-1/2 text-3xl border-none bottom-1 lg:bottom-5 z-50 px-10 py-2 gwfont bg-brown-brushed hover:scale-125 transition-all rounded-full border-b border-black shadow-md text-white',
            {
              'opacity-50': !marker,
            }
          )}
